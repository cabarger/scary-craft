...
pub extern fn GetCameraForward(camera: *Camera) Vector3;
pub extern fn GetCameraUp(camera: *Camera) Vector3;
pub extern fn GetCameraRight(camera: *Camera) Vector3;
...
pub const rlgl = struct {
    ...
    // rlgl functionality -------------------------------------------------
    extern fn rlSetTexture(id: c_uint) void;

    /// Set current texture for render batch and check buffers limits
    pub inline fn SetTexture(id: c_uint) void {
        rlSetTexture(id);
    }
    ...
    extern fn rlVertex2i(x: c_int, y: c_int) void; // Define one vertex (position) - 2 int
    extern fn rlVertex2f(x: f32, y: f32) void; // Define one vertex (position) - 2 f32
    extern fn rlVertex3f(x: f32, y: f32, z: f32) void; // Define one vertex (position) - 3 f32
    extern fn rlTexCoord2f(x: f32, y: f32) void; // Define one vertex (texture coordinate) - 2 f32
    extern fn rlNormal3f(x: f32, y: f32, z: f32) void; // Define one vertex (normal) - 3 f32
    extern fn rlColor4ub(r: u8, g: u8, b: u8, a: u8) void; // Define one vertex (color) - 4 byte
    extern fn rlColor3f(x: f32, y: f32, z: f32) void; // Define one vertex (color) - 3 f32
    extern fn rlColor4f(x: f32, y: f32, z: f32, w: f32) void; // Define one vertex (color) - 4 f32

    /// Initialize drawing mode (how to organize vertex)
    pub inline fn Begin(mode: c_int) void {
        rlBegin(mode);
    }
    ...
    pub inline fn Vertex2i(x: c_int, y: c_int) void {
        rlVertex2i(x, y);
    }
    /// Define one vertex (position) - 2 f32
    pub inline fn Vertex2f(x: f32, y: f32) void {
        rlVertex2f(x, y);
    }
    /// Define one vertex (position) - 3 f32
    pub inline fn Vertex3f(x: f32, y: f32, z: f32) void {
        rlVertex3f(x, y, z);
    }
    /// Define one vertex (texture coordinate) - 2 f32
    pub inline fn TexCoord2f(x: f32, y: f32) void {
        rlTexCoord2f(x, y);
    }
    /// Define one vertex (normal) - 3 f32
    pub inline fn Normal3f(x: f32, y: f32, z: f32) void {
        rlNormal3f(x, y, z);
    }
    /// Define one vertex (color) - 4 byte
    pub inline fn Color4ub(r: u8, g: u8, b: u8, a: u8) void {
        rlColor4ub(r, g, b, a);
    }
    /// Define one vertex (color) - 3 f32
    pub inline fn Color3f(x: f32, y: f32, z: f32) void {
        rlColor3f(x, y, z);
    }
    /// Define one vertex (color) - 4 f32
    pub inline fn Color4f(x: f32, y: f32, z: f32, w: f32) void {
        rlColor4f(x, y, z, w);
    }
};
